...
public class UserRegisterFragment extends Fragment implements FragmentBottomSheet.ImageChoosedListener, View.OnClickListener {
    View view;
    ...
    AppPrefs prefs;
    UserRegisterFragmentCommunicator communicator;
    InstagramSession instagramSession;
    private InstagramApp mApp;
    EditInfoResponse resource;

    public void setUserRegisterFragmentCommunicator(UserRegisterFragmentCommunicator communicator){
...
//        Picasso.with(getContext()).load(prefs.getString(Constants.TAG_PROFILE_PICTURE)).placeholder(R.drawable.profile).into(imageView_big);
    ...
    private void setEditInfoDetail(){
        ...
        picker_date_of_birth.setText(user.dob);
        ...
        ImageView[] imageView ={imageView_small1,imageView_small2,iv_pic1,iv_pic2,iv_pic3};
        if(photos!=null) {
...
/*private void uploadEditIfo(){
    ...
    private RegisterUser getparameter(){
        ...
        registerUser.device_type="android";
        registerUser.dob="1498721234";//picker_date_of_birth.getText().toString();
    ...
    public interface UserRegisterFragmentCommunicator{
        void userRegister(RegisterUser parameter,ImageUploadRequest photoParam);
