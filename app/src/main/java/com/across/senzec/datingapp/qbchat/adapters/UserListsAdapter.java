...
public class UserListsAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<QBUser> qbUserArrayList;

    public UserListsAdapter(Context context, ArrayList<QBUser> qbUserArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
          ...
          //  txv.setText(qbUserArrayList.get(position).getLogin());
            txv.append(qbUserArrayList.get(position).getFullName());
